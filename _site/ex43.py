    ...
    def enter(self):
        ...
        if guess == code:
            print(dedent("""
                  ...
                  you can to the bridge wher you must place it in the
                  right spot.
            """))
            return 'the_bridge'
        else:
    ...
    def enter(self):
        ...
        if action == 'throw the bomb':
            print(dedent("""
                  ...
                  diasrm the bom. You die knowing they will probably
                  blow up when the bomb goes off.
            """))
            return 'death'
    ...
    def enter(self):
        ...
        if int(guess) != good_pod:
            print(dedent("""
                  ...
                  The pod esacapes out into the void of space, then
            ...
            print(dedent("""
                  ...
                  back and see your ship inplode then explode like a
